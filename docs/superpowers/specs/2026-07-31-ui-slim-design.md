...
**日期**：2026-07-31
**状态**：Shipped 2026-07-31（I1–I4 落地。实测:侧栏常显 21→9 元素,顶栏 11→5,File 菜单 12→7 项,底部常驻 60→26px,main_window 1027→939 行。偏差:折叠态样张条只显徽章不含 Aa 微样;main_window 未达 <900 行的软目标——薄委托层保留了 API 兼容,值得这几十行）
